    ...
    <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div class="flex flex-wrap gap-2">
            <a href="{{ route('activity-logs.report', $reportQuery) }}"
               ...
               class="inline-flex items-center justify-center rounded-xl bg-brand px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-brand-hover">
                Print report
            </a>
            @if ($filtersActive)
    ...
    <form method="get" action="{{ route('activity-logs.index') }}" class="mb-6 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        ...
        <div class="space-y-4 p-5">
            ...
            <div class="flex flex-wrap items-center gap-3">
                <button type="submit" class="rounded-xl bg-brand px-4 py-2.5 text-sm font-semibold text-white hover:bg-brand-hover">Apply filters</button>
                                            ...
                                            <div class="mt-3 flex flex-wrap items-center gap-3 text-sm text-slate-700">
                                                @if ($log->user)
                                                    <span class="inline-flex items-center gap-2">
                                                        <span class="inline-flex h-7 w-7 items-center justify-center rounded-full bg-brand text-xs font-semibold text-white">
                                                            {{ $initial }}
                                                        </span>
                                                        <span>
