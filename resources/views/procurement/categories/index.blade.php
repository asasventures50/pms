                ...
                @forelse ($categories as $category)
                    <tr class="hover:bg-slate-50/80">
                        ...
                        <td class="whitespace-nowrap px-3 py-2 text-right text-xs">
                            ...
                            <span class="mx-1 text-slate-300">|</span>
                            <form action="{{ route('categories.destroy', $category) }}" method="post" class="inline" onsubmit="return confirm('Delete this category and its subcategories? Linked vendors will be unlinked but not deleted.');">
                                    @csrf
                                    @method('DELETE')
