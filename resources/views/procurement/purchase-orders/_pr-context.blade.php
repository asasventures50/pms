...
<div id="po-pr-context"
    ...
    <dl class="mt-3 grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-7">
        <div>
        ...
        <div>
            ...
            <dd id="po-pr-context-geographic-scope" class="mt-0.5 text-slate-900">{{ $prContext['geographic_scope'] ?? '—' }}</dd>
        </div>
        <div>
