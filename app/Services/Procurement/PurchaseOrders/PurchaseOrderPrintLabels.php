...
class PurchaseOrderPrintLabels
{
    private const EN = [
        ...
        'execution_delivery_days' => 'Time period for execution and delivery of the works from the Purchase Order issue date:',
        'days_unit' => 'days',
        'payment_terms' => 'Payment terms:',
        'payment_term_condition' => 'Payment term',
        'payment_term_percent' => 'Percentage (%)',
        'payment_term_amount' => 'Amount',
        'payment_term_currency' => 'Currency',
        'notes' => 'Notes:',
    ...
    private const AR = [
        ...
        'execution_delivery_days' => 'المدة الزمنية لتنفيذ وتسليم الأعمال اعتباراً من تاريخ إصدار أمر الشراء:',
        'days_unit' => 'يوم',
        'payment_terms' => 'شروط الدفع:',
        'payment_term_condition' => 'الدفعة / الشرط',
        'payment_term_percent' => 'النسبة (%)',
        'payment_term_amount' => 'المبلغ',
        'payment_term_currency' => 'العملة',
        'notes' => 'ملاحظات:',
