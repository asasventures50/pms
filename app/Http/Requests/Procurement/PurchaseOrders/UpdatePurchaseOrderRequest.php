...
class UpdatePurchaseOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            ...$this->vendorFieldRules(sometimes: true),
            ...
            'show_retention' => ['sometimes', 'nullable', 'boolean'],
            'primary_insurance_applicable' => ['sometimes', 'nullable', 'boolean'],
            'primary_insurance_requirements' => ['sometimes', 'nullable', 'string', 'max:10000'],
            'final_insurance_applicable' => ['sometimes', 'nullable', 'boolean'],
            'final_insurance_requirements' => ['sometimes', 'nullable', 'string', 'max:10000'],
            'show_insurance' => ['sometimes', 'nullable', 'boolean'],
