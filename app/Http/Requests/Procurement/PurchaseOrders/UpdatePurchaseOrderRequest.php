...
class UpdatePurchaseOrderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'payment_term_rows' => ['sometimes', 'nullable', 'array'],
            'payment_term_rows.*.id' => ['sometimes', 'nullable', 'integer'],
            ...
            'after_sale_service_applicable' => ['sometimes', 'nullable', 'boolean'],
            'warranty_years' => ['sometimes', 'nullable', 'numeric', 'min:0', 'max:999'],
            ...
            'execution_delivery_days' => ['sometimes', 'nullable', 'integer', 'min:0', 'max:9999'],
